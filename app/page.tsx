...
"
        >
          ...
          <div className="flex justify-center">
            <Link
              href="/reviews"
              className="rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 mr-4 hover:scale-105"
            >
              [리뷰 보러가기]
            </Link>
            <Link
              href="/analysis"
              className="rounded-md border border-blue-500 px-5 py-2 text-blue-600 hover:bg-blue-50 hover:scale-105"
            >
              [AI분석 결과 보기]
            </Link>
          </div>
